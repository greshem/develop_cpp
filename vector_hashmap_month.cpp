...
public:  
 	 ...
 	 //    
 	     ...
 	     {    
 	         return stdext::hash_value(  str.c_str() );  // use MS STL build-in hash function for TCHAR*    
 	     }    
 	 //////////////////////////////////////////////////////////////////////////    
 	 //    
 	 //  Hash Comparetor Function    
 	 //    
 	     bool operator()(const TCHAR* p1, const TCHAR*p2) const{    
 	         return _tcscmp(p1,p2) == 0;    
 	     }    
 	 };   

	int get_keys( hash_map<const char*, int,stdext::hash_value<const char *>  eqstr> & months, vector<string> &vec_string )
#else
