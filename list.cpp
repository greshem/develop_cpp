 ...
 * entries already!
 */
static __inline__ void __list_add(struct list_head * in ,struct list_head * prev, struct list_head * next)
{
	next->prev = in;
	in->next = next;
	in->prev = prev;
 ...
 */
static __inline__ void list_add(struct list_head *in, struct list_head *head)
{
 ...
 */
static __inline__ void list_add_tail(struct list_head *in, struct list_head *head)
{
